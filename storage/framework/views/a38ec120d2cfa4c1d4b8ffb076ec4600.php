...
<main class="product-form-page">
    <div class="container">
        ...
        <div class="form-container">
            <form action="<?php echo e(route('products.store')); ?>" method="POST" enctype="multipart/form-data" class="product-form">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-grid">
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="sku" name="sku" value="<?php echo e(old('sku')); ?>" required class="form-control">
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group half">
                                ...
                                <input type="number" id="price" name="price" value="<?php echo e(old('price')); ?>" step="0.01" min="0" required class="form-control">
                            </div>
                            
                            <div class="form-group half">
                                <label for="sale_price">Precio de Oferta</label>
                                <input type="number" id="sale_price" name="sale_price" value="<?php echo e(old('sale_price')); ?>" step="0.01" min="0" class="form-control">
                            </div>
                        </div>
                        
                        <div class="form-group">
                            <label for="stock_quantity">Cantidad en Stock<span class="required">*</span></label>
                            <input type="number" id="stock_quantity" name="stock_quantity" value="<?php echo e(old('stock_quantity', 0)); ?>" min="0" required class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="short_description" name="short_description" rows="3" class="form-control"><?php echo e(old('short_description')); ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" rows="6" required class="form-control"><?php echo e(old('description')); ?></textarea>
                        </div>
                    </div>
