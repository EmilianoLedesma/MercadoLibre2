...
<section style="padding: 60px 20px; background: white;">
    <div style="max-width: 1200px; margin: 0 auto;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 32px;">
            ...
            <a href="<?php echo e(route('products.create')); ?>" style="display: inline-flex; align-items: center; gap: 8px; background: #EE403D; color: white; padding: 14px 28px; border-radius: 8px; text-decoration: none; font-family: 'Jost', sans-serif; font-weight: 600; font-size: 15px; transition: all 0.3s;">
        ...
        <?php if(session('success')): ?>
            <div style="background: #D4EDDA; border: 1px solid #C3E6CB; border-radius: 8px; padding: 16px 20px; margin-bottom: 24px; display: flex; align-items: center; gap: 12px;">
                ...
                <span style="color: #155724; font-family: 'Jost', sans-serif; font-size: 15px;"><?php echo e(session('success')); ?></span>
            </div>
        <?php endif; ?>
        ...
        <?php if(session('error')): ?>
            <div style="background: #F8D7DA; border: 1px solid #F5C6CB; border-radius: 8px; padding: 16px 20px; margin-bottom: 24px; display: flex; align-items: center; gap: 12px;">
                ...
                <span style="color: #721C24; font-family: 'Jost', sans-serif; font-size: 15px;"><?php echo e(session('error')); ?></span>
            </div>
        <?php endif; ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr style="border-bottom: 1px solid #F1F3F5; transition: background-color 0.2s ease;" onmouseover="this.style.backgroundColor='#F8F9FA'" onmouseout="this.style.backgroundColor='white'">
                                    <td style="padding: 20px; color: #212529; font-family: 'Jost', sans-serif; font-size: 14px; font-weight: 600;"><?php echo e($product->id); ?></td>
                                    <td style="padding: 20px;">
                                        <div style="width: 60px; height: 60px; border-radius: 6px; overflow: hidden; background: #F8F9FA;">
                                            ...
                                            ?>
                                            <img src="<?php echo e($imageUrl); ?>" alt="<?php echo e($product->name); ?>" style="width: 100%; height: 100%; object-fit: cover;">
                                        </div>
                                    </td>
                                    <td style="padding: 20px; color: #212529; font-family: 'Jost', sans-serif; font-size: 14px; font-weight: 500;"><?php echo e($product->name); ?></td>
                                    <td style="padding: 20px; color: #495057; font-family: 'Jost', sans-serif; font-size: 14px;"><?php echo e($product->sku); ?></td>
                                    <td style="padding: 20px; color: #212529; font-family: 'Jost', sans-serif; font-size: 14px; font-weight: 600;">$<?php echo e(number_format($product->price, 2)); ?></td>
                                    <td style="padding: 20px; color: #495057; font-family: 'Jost', sans-serif; font-size: 14px; font-weight: 500;"><?php echo e($product->stock_quantity); ?></td>
                                    <td style="padding: 20px; color: #495057; font-family: 'Jost', sans-serif; font-size: 14px;"><?php echo e($product->category->name ?? 'N/A'); ?></td>
                                    <td style="padding: 20px;">
                                        <span style="display: inline-block; padding: 6px 12px; border-radius: 20px; font-size: 12px; font-weight: 600; <?php echo e($product->is_active ? 'background: #D4EDDA; color: #28A745;' : 'background: #F8D7DA; color: #DC3545;'); ?>">
                                    ...
                                    <td style="padding: 20px;">
                                        <div style="display: flex; gap: 8px; align-items: center;">
                                            ...
                                            <a href="<?php echo e(route('products.edit', $product)); ?>" style="width: 36px; height: 36px; border-radius: 6px; border: none; display: flex; align-items: center; justify-content: center; cursor: pointer; transition: all 0.2s ease; background: transparent; text-decoration: none; color: #EE403D;" title="Editar" onmouseover="this.style.backgroundColor='#FFE5E4'; this.style.color='#E32020'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#EE403D'">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button type="button" onclick="confirmDelete(<?php echo e($product->id); ?>, '<?php echo e(addslashes($product->name)); ?>')" style="width: 36px; height: 36px; border-radius: 6px; border: none; display: flex; align-items: center; justify-content: center; cursor: pointer; transition: all 0.2s ease; background: transparent; color: #DC3545;" title="Eliminar" onmouseover="this.style.backgroundColor='#FFE5E8'; this.style.color='#C82333'" onmouseout="this.style.backgroundColor='transparent'; this.style.color='#DC3545'">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Emiliano\Documents\UPQ SISTEMAS\7mo_Cuatrimestre\Programación Web\ML2 Seals Edition\MercadoLibre2\resources\views/products/index.blade.php ENDPATH**/ ?>