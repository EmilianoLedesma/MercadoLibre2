...
<main class="products-page">
    <div class="container">
        <div class="page-header">
            ...
            <a href="<?php echo e(route('products.create')); ?>" class="btn btn-primary">Nuevo Producto</a>
        </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="product-image">
                                ...
                                ?>
                                <?php if($imagePath): ?>
                                    <img src="<?php echo e(asset('storage/' . $imagePath)); ?>" alt="<?php echo e($product->name); ?>">
                                <?php else: ?>
                            ...
                            <td class="actions">
                                <a href="<?php echo e(route('products.show', $product)); ?>" class="btn-action view" title="Ver detalles">
                                ...
                                <form action="<?php echo e(route('products.destroy', $product)); ?>" method="POST" class="delete-form" onsubmit="return confirm('¿Estás seguro de eliminar este producto?');">
                                    <?php echo csrf_field(); ?>
