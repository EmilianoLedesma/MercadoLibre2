...
<header style="background-color: white; position: sticky; top: 0; z-index: 1000; box-shadow: 0 2px 8px rgba(0,0,0,0.08); padding: 20px 0;">
    <div style="max-width: 1200px; margin: 0 auto; display: flex; justify-content: space-between; align-items: center; padding: 0 20px;">
        ...
        <div style="display: flex; gap: 16px; align-items: center;">
            ...
            <?php endif; ?>
            <a href="<?php echo e(route('cart')); ?>" style="color: #EE403D; text-decoration: none; position: relative;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Lenguajes Automatas\MercadoLibre2\resources\views/cart.blade.php ENDPATH**/ ?>