    ...
    <div class="container">
        <div class="page-header">
            ...
            <div class="header-actions">
                ...
                <a href="<?php echo e(route('products.index')); ?>" class="btn btn-secondary">Volver a Lista</a>
            </div>
        </div>
            ...
            <div class="product-gallery">
                ...
                <?php if(count($images) > 0): ?>
                    <div class="product-main-image">
                        <img src="<?php echo e(asset('storage/' . $images[0])); ?>" alt="<?php echo e($product->name); ?>" id="mainImage">
                    </div>
                    
                    <?php if(count($images) > 1): ?>
                        <div class="product-thumbnails">
                            <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="thumbnail <?php echo e($index === 0 ? 'active' : ''); ?>" data-image="<?php echo e(asset('storage/' . $image)); ?>">
                                    <img src="<?php echo e(asset('storage/' . $image)); ?>" alt="<?php echo e($product->name); ?> - imagen <?php echo e($index + 1); ?>">
                                </div>
            ...
            <div class="product-info">
                ...
                <div class="product-meta">
                    ...
                    <div class="meta-item">
                        ...
                        <span class="meta-value"><?php echo e($product->stock_quantity); ?> unidades</span>
                    </div>
                </div>
                
                <div class="product-pricing">
                    <?php if($product->sale_price): ?>
                        <div class="original-price">$<?php echo e(number_format($product->price, 2)); ?></div>
                        <div class="sale-price">$<?php echo e(number_format($product->sale_price, 2)); ?></div>
                        <?php
                            $discount = (($product->price - $product->sale_price) / $product->price) * 100;
                        ?>
                        <div class="discount-tag"><?php echo e(round($discount)); ?>% OFF</div>
                    <?php else: ?>
                        <div class="current-price">$<?php echo e(number_format($product->price, 2)); ?></div>
                    <?php endif; ?>
                </div>
                
                <div class="product-short-description">
                    <p><?php echo e($product->short_description ?? 'Sin descripción corta disponible.'); ?></p>
                </div>
                
                <div class="product-actions">
                    <form action="<?php echo e(route('products.destroy', $product)); ?>" method="POST" onsubmit="return confirm('¿Estás seguro de eliminar este producto?');">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="product-details">
                        <table class="details-table">
                            <tbody>
                                ...
                                <tr>
                                    <th>Vendedor</th>
                                    <td><?php echo e($product->user->name ?? 'Desconocido'); ?></td>
                                </tr>
                                <tr>
                                    <th>Estado</th>
                                    <td>
                                        <span class="status <?php echo e($product->is_active ? 'active' : 'inactive'); ?>">
