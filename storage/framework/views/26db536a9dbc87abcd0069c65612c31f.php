    ...
    <div style="max-width: 1200px; margin: 0 auto; display: flex; justify-content: space-between; align-items: center; padding: 0 20px;">
        ...
        <nav style="display: flex; gap: 32px; align-items: center;">
            ...
            <div style="position: relative;" class="categories-dropdown">
                <a href="<?php echo e(route('categories')); ?>" style="color: #666; font-weight: 500; text-decoration: none; transition: color 0.25s; display: flex; align-items: center; gap: 6px; font-size: 16px; font-family: 'Jost', sans-serif;">
                    Categorías
                ...
                <div class="dropdown-menu">
                    <div style="display: grid; gap: 12px;">
                        ...
                        ?>
                        <?php $__currentLoopData = $shopNavCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
