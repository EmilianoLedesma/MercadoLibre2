<?php $__env->startSection('title', 'Lista de Deseos'); ?>
...
<section style="padding: 60px 20px; background: white; min-height: 60vh;">
    <div style="max-width: 1200px; margin: 0 auto;">
            ...
            <div style="overflow-x: auto;">
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid #E5E5E5;" id="wishlist-item-<?php echo e($item->id); ?>">
                            <!-- Remove Button -->
                            <td style="padding: 20px; text-align: center;">
                                <button onclick="removeFromWishlist(<?php echo e($item->id); ?>)" style="background: none; border: none; color: #999; cursor: pointer; font-size: 18px; width: 40px; height: 40px; border-radius: 50%; transition: all 0.3s;" onmouseover="this.style.background='#FEF2F2'; this.style.color='#EF4444';" onmouseout="this.style.background='none'; this.style.color='#999';">
                            ...
                            <td style="padding: 20px;">
                                <div style="display: flex; align-items: center; gap: 16px;">
                                    <a href="<?php echo e(route('shop.show', $item->slug)); ?>" style="flex-shrink: 0;">
                                        <img src="<?php echo e($item->image ?? '/images/placeholder.jpg'); ?>" alt="<?php echo e($item->name); ?>" style="width: 80px; height: 80px; object-fit: cover; border-radius: 8px; border: 1px solid #E5E5E5;">
                                    </a>
                                    <div>
                                        <a href="<?php echo e(route('shop.show', $item->slug)); ?>" style="font-family: 'Jost', sans-serif; font-size: 16px; font-weight: 600; color: #212529; text-decoration: none; display: block; margin-bottom: 4px; transition: color 0.3s;" onmouseover="this.style.color='#EE403D'" onmouseout="this.style.color='#212529'">
                                            <?php echo e($item->name); ?>

                                        </a>
                                        <?php if($item->category): ?>
                                        <div style="font-size: 13px; color: #999;"><?php echo e($item->category->name); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
            <!-- Clear Wishlist -->
            <form action="<?php echo e(route('wishlist.clear')); ?>" method="POST" onsubmit="return confirm('Are you sure you want to clear your entire wishlist?');">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Emiliano\Documents\UPQ SISTEMAS\7mo_Cuatrimestre\Programación Web\ML2 Seals Edition\MercadoLibre2\resources\views/wishlist/index.blade.php ENDPATH**/ ?>