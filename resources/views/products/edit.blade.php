                ...
                <div>
                    ...
                    <div style="background: white; border: 1px solid #E5E5E5; border-radius: 12px; padding: 32px; margin-bottom: 24px;">
                        ...
                        <div style="margin-bottom: 20px;">
                            ...
                            <input type="text" name="name" value="{{ old('name', $product->name) }}" required style="width: 100%; padding: 12px 16px; border: 1px solid #E5E5E5; border-radius: 8px; font-family: 'Jost', sans-serif; font-size: 15px; transition: border-color 0.3s;" onfocus="this.style.borderColor='#EE403D'" onblur="this.style.borderColor='#E5E5E5'">
                        </div>
                        ...
                        <div style="margin-bottom: 20px;">
                            ...
                            <input type="text" name="sku" value="{{ old('sku', $product->sku) }}" required style="width: 100%; padding: 12px 16px; border: 1px solid #E5E5E5; border-radius: 8px; font-family: 'Jost', sans-serif; font-size: 15px; transition: border-color 0.3s;" onfocus="this.style.borderColor='#EE403D'" onblur="this.style.borderColor='#E5E5E5'">
                        </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 20px;">
                            <div>
                                ...
                                <input type="number" name="price" value="{{ old('price', $product->price) }}" step="0.01" min="0" required style="width: 100%; padding: 12px 16px; border: 1px solid #E5E5E5; border-radius: 8px; font-family: 'Jost', sans-serif; font-size: 15px; transition: border-color 0.3s;" onfocus="this.style.borderColor='#EE403D'" onblur="this.style.borderColor='#E5E5E5'">
                            </div>
                            <div>
                                <label style="display: block; margin-bottom: 8px; font-family: 'Jost', sans-serif; font-weight: 600; color: #212529; font-size: 14px;">
                                    Precio de Oferta
                                </label>
                                <input type="number" name="sale_price" value="{{ old('sale_price', $product->sale_price) }}" step="0.01" min="0" style="width: 100%; padding: 12px 16px; border: 1px solid #E5E5E5; border-radius: 8px; font-family: 'Jost', sans-serif; font-size: 15px; transition: border-color 0.3s;" onfocus="this.style.borderColor='#EE403D'" onblur="this.style.borderColor='#E5E5E5'">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="stock_quantity" value="{{ old('stock_quantity', $product->stock_quantity) }}" min="0" required style="width: 100%; padding: 12px 16px; border: 1px solid #E5E5E5; border-radius: 8px; font-family: 'Jost', sans-serif; font-size: 15px; transition: border-color 0.3s;" onfocus="this.style.borderColor='#EE403D'" onblur="this.style.borderColor='#E5E5E5'">
                        </div>
                    </div>
                    ...
                    <div style="background: white; border: 1px solid #E5E5E5; border-radius: 12px; padding: 32px;">
                        ...
                        <div style="margin-bottom: 16px;">
                            <label style="display: flex; align-items: center; gap: 12px; cursor: pointer;">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $product->is_active) ? 'checked' : '' }} style="width: 20px; height: 20px; cursor: pointer;">
                        ...
                        <div>
                            <label style="display: flex; align-items: center; gap: 12px; cursor: pointer;">
                                <input type="checkbox" name="is_featured" value="1" {{ old('is_featured', $product->is_featured) ? 'checked' : '' }} style="width: 20px; height: 20px; cursor: pointer;">
                ...
                <div>
                    ...
                    <div style="background: white; border: 1px solid #E5E5E5; border-radius: 12px; padding: 32px; margin-bottom: 24px;">
                        ...
                        <div style="margin-bottom: 20px;">
                            ...
                            <textarea name="short_description" rows="3" style="width: 100%; padding: 12px 16px; border: 1px solid #E5E5E5; border-radius: 8px; font-family: 'Jost', sans-serif; font-size: 15px; transition: border-color 0.3s; resize: vertical;" onfocus="this.style.borderColor='#EE403D'" onblur="this.style.borderColor='#E5E5E5'">{{ old('short_description', $product->short_description) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="6" required style="width: 100%; padding: 12px 16px; border: 1px solid #E5E5E5; border-radius: 8px; font-family: 'Jost', sans-serif; font-size: 15px; transition: border-color 0.3s; resize: vertical;" onfocus="this.style.borderColor='#EE403D'" onblur="this.style.borderColor='#E5E5E5'">{{ old('description', $product->description) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div style="background: white; border: 1px solid #E5E5E5; border-radius: 12px; padding: 32px;">
                                    ...
                                    @foreach($images as $index => $image)
                                        <div style="position: relative; border-radius: 8px; overflow: hidden; border: 2px solid #E5E5E5; transition: all 0.3s;" onmouseover="this.style.borderColor='#EE403D'; this.style.transform='translateY(-4px)'" onmouseout="this.style.borderColor='#E5E5E5'; this.style.transform='translateY(0)'">
                                            <div style="width: 100%; padding-top: 100%; position: relative; background: #F8F9FA;">
                                                <img src="{{ asset('storage/' . $image) }}" alt="{{ $product->name }}" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover;">
                                            </div>
                                            <div style="padding: 8px; background: #FAFAFA; border-top: 1px solid #E5E5E5;">
                                                <label style="display: flex; align-items: center; gap: 6px; cursor: pointer; font-size: 12px; color: #DC3545; font-family: 'Jost', sans-serif; font-weight: 500;">
                                                    <input type="checkbox" name="delete_images[]" value="{{ $index }}" style="width: 16px; height: 16px; cursor: pointer;">
                                                    Eliminar
                                                </label>
                                            </div>
                                        </div>
                        ...
                        <div>
                            <label style="display: block; margin-bottom: 12px; font-family: 'Jost', sans-serif; font-weight: 600; color: #212529; font-size: 14px;">
                                {{ count($images) > 0 ? 'Añadir Nuevas Imágenes' : 'Imágenes del Producto' }}
                            </label>
