                ...
                <div class="form-grid">
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="sku" name="sku" value="{{ old('sku') }}" required class="form-control">
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group half">
                                ...
                                <input type="number" id="price" name="price" value="{{ old('price') }}" step="0.01" min="0" required class="form-control">
                            </div>
                            
                            <div class="form-group half">
                                <label for="sale_price">Precio de Oferta</label>
                                <input type="number" id="sale_price" name="sale_price" value="{{ old('sale_price') }}" step="0.01" min="0" class="form-control">
                            </div>
                        </div>
                        
                        <div class="form-group">
                            <label for="stock_quantity">Cantidad en Stock<span class="required">*</span></label>
                            <input type="number" id="stock_quantity" name="stock_quantity" value="{{ old('stock_quantity', 0) }}" min="0" required class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="short_description" name="short_description" rows="3" class="form-control">{{ old('short_description') }}</textarea>
