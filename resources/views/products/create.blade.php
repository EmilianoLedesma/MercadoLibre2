                ...
                <div>
                    ...
                    <div style="background: white; border: 1px solid #E5E5E5; border-radius: 12px; padding: 32px; margin-bottom: 24px;">
                        ...
                        <div style="margin-bottom: 20px;">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" required style="width: 100%; padding: 12px 16px; border: 1px solid #E5E5E5; border-radius: 8px; font-family: 'Jost', sans-serif; font-size: 15px; transition: border-color 0.3s;" onfocus="this.style.borderColor='#EE403D'" onblur="this.style.borderColor='#E5E5E5'">
                        </div>
                        ...
                        <div style="margin-bottom: 20px;">
                            ...
                            <input type="text" name="sku" value="{{ old('sku') }}" required style="width: 100%; padding: 12px 16px; border: 1px solid #E5E5E5; border-radius: 8px; font-family: 'Jost', sans-serif; font-size: 15px; transition: border-color 0.3s;" onfocus="this.style.borderColor='#EE403D'" onblur="this.style.borderColor='#E5E5E5'">
                        </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 20px;">
                            <div>
                                ...
                                <input type="number" name="price" value="{{ old('price') }}" step="0.01" min="0" required style="width: 100%; padding: 12px 16px; border: 1px solid #E5E5E5; border-radius: 8px; font-family: 'Jost', sans-serif; font-size: 15px; transition: border-color 0.3s;" onfocus="this.style.borderColor='#EE403D'" onblur="this.style.borderColor='#E5E5E5'">
                            </div>
                            <div>
                                <label style="display: block; margin-bottom: 8px; font-family: 'Jost', sans-serif; font-weight: 600; color: #212529; font-size: 14px;">
                                    Precio de Oferta
                                </label>
                                <input type="number" name="sale_price" value="{{ old('sale_price') }}" step="0.01" min="0" style="width: 100%; padding: 12px 16px; border: 1px solid #E5E5E5; border-radius: 8px; font-family: 'Jost', sans-serif; font-size: 15px; transition: border-color 0.3s;" onfocus="this.style.borderColor='#EE403D'" onblur="this.style.borderColor='#E5E5E5'">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="stock_quantity" value="{{ old('stock_quantity', 0) }}" min="0" required style="width: 100%; padding: 12px 16px; border: 1px solid #E5E5E5; border-radius: 8px; font-family: 'Jost', sans-serif; font-size: 15px; transition: border-color 0.3s;" onfocus="this.style.borderColor='#EE403D'" onblur="this.style.borderColor='#E5E5E5'">
                        </div>
                    </div>
                    ...
                    <div style="background: white; border: 1px solid #E5E5E5; border-radius: 12px; padding: 32px;">
                        ...
                        <div style="margin-bottom: 16px;">
                            <label style="display: flex; align-items: center; gap: 12px; cursor: pointer;">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', '1') ? 'checked' : '' }} style="width: 20px; height: 20px; cursor: pointer;">
                ...
                <div>
                    ...
                    <div style="background: white; border: 1px solid #E5E5E5; border-radius: 12px; padding: 32px; margin-bottom: 24px;">
                        ...
                        <div style="margin-bottom: 20px;">
                            ...
                            <textarea name="short_description" rows="3" style="width: 100%; padding: 12px 16px; border: 1px solid #E5E5E5; border-radius: 8px; font-family: 'Jost', sans-serif; font-size: 15px; transition: border-color 0.3s; resize: vertical;" onfocus="this.style.borderColor='#EE403D'" onblur="this.style.borderColor='#E5E5E5'">{{ old('short_description') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="6" required style="width: 100%; padding: 12px 16px; border: 1px solid #E5E5E5; border-radius: 8px; font-family: 'Jost', sans-serif; font-size: 15px; transition: border-color 0.3s; resize: vertical;" onfocus="this.style.borderColor='#EE403D'" onblur="this.style.borderColor='#E5E5E5'">{{ old('description') }}</textarea>
                        </div>
                    </div>
