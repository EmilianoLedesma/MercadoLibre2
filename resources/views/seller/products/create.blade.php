...
<main style="background-color: #F5F6F2; padding: 40px 0; min-height: calc(100vh - 400px);">
    <div style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
            <h1 style="font-size: 28px; font-weight: 600; color: #212529;">Crear Nuevo Producto</h1>
            <a href="{{ route('seller.products.index') }}" style="display: inline-block; padding: 10px 20px; background-color: white; color: #212529; border: 1px solid #D7D9D2; border-radius: 4px; text-decoration: none; font-weight: 500; transition: all 0.25s;">
                ← Volver a Lista
            </a>
        </div>
                    ...
                    <div style="display: grid; gap: 20px;">
                        <div>
                            ...
                            <textarea name="short_description" rows="2" 
                                ...
                                placeholder="Breve resumen del producto">{{ old('short_description') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="6" required 
                                style="width: 100%; padding: 12px 16px; border: 1px solid #D7D9D2; border-radius: 4px; font-size: 15px; resize: vertical; transition: border-color 0.2s;"
                                placeholder="Descripción detallada del producto, características, materiales, etc.">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <div style="background-color: #F5F6F2; padding: 16px; border-radius: 4px;">
                            <label style="display: flex; align-items: start; cursor: pointer;">
                                ...
                                <div>
                                    ...
                                    <span style="font-size: 13px; color: #777777; display: block;">Si se desactiva, el producto no estará disponible para compra pero permanecerá en el sistema</span>
                                </div>
                            </label>
                        </div>
